...
```
cd existing_repo
git remote add origin https://git.photonicdata.science/redg/mmir_gui.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.photonicdata.science/redg/mmir_gui/-/settings/integrations)
